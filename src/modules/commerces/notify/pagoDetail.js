...
import { Container, Content, List, ListItem, Thumbnail, Left, Body } from 'native-base';
...
export default function ShippingNotification({navigation, route}) {
    ...
    return (
        <ScrollView style={styles.scrollView}>
            <View style={styles.titleStore}>
                ...
                <Text style={[styles.titleTextStore, styles.fontFamily,{color:'#656565'}]}>Fecha 10/06/2020</Text>
                <Text style={[styles.titleTextStore, styles.fontFamily,{color:'#EA5743',fontWeight:'bold'}]}>Pago Pendiente</Text>
            </View>
