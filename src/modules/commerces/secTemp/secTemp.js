...
export default class SecTemp extends React.Component {
    ...
    constructor(props){
        ...
        AdminProductos.getDataProductosTemporadaFromCommerce()
        .then((productos)=>{
            ...
            <ScrollView style={{}}>
                ...
                <View style={{
                    ...
                    <View style={{
                        ...
                        alignItems:'center',
                        paddingVertical:Dimensions.get('window').height*0.0075
                    }}>
                        <Text style={{
                            color:'#5F27A4'
                        }}>
                    ...
                    <View style={{
                        ...
                        <View style={{
                            ...
                            <Text style={{
                                ...
                                No tiene productos registrado en esta temporada
                            </Text>
                        </View>:null}
                        <View style={{
    ...
    saveProduct = async (keyP)=>{
        ...
        producto.id = producto.idTienda+"_temp_"+index
        producto.numP = index
        if(await AdminProductos.setProductTempData(producto)){
    ...
    save = async (keyP)=>{
        ...
        if(await AdminProductos.updateProductTemporada(this.state.productos[keyP])){
